...
script create_credits_menu 
	...
	if NOT ($end_credits = 1)
		...
		createScreenElement \{Type = spriteElement Id = credits_backdrop PARENT = credits_backdrop_container texture = endcredits_BG rgba = [255 255 255 255] pos = (640.0, 360.0) Dims = (1280.0, 720.0) just = [Center Center] z_priority = 0 Alpha = 1}
	endif
	PopAssetContext
	if NOT ($end_credits = 1)
		event_handlers = [
