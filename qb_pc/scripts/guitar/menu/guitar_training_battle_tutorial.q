...
script training_3_2_show_lesson 
	...
	CreateScreenElement \{parent = training_container type = SpriteElement id = guitar_sprite just = [center center] texture = training_guitar_small Pos = (400.0, 400.0) rot_angle = 45 rgba = [255 255 255 255] Scale = (0.8, 0.8) z_priority = 50}
