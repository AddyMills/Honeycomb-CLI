...
script GuitarEvent_SongFailed_Spawned 
	...
	if ($boss_battle = 1)
		...
		spawnscriptnow \{jiggle_text_array_elements params = {id = yourock_text
				time = 1.0
				wait_time = 3000
				explode = 1}}
	endif
...
script GuitarEvent_SongWon_Spawned 
	...
	if NOT ($devil_finish = 1 || $battle_sudden_death = 1)
		...
		spawnscriptnow \{jiggle_text_array_elements params = {id = yourock_text
				...
				explode = 1}}
		if (<rock_legend> = 1)
			spawnscriptnow \{jiggle_text_array_elements params = {id = yourock_text_legend
					time = 1.0
					wait_time = 3000
					explode = 1}}
		endif
		if ($is_network_game)
			spawnscriptnow \{jiggle_text_array_elements params = {id = yourock_text_2
					time = 1.0
					wait_time = 3000
					explode = 1}}
		endif
