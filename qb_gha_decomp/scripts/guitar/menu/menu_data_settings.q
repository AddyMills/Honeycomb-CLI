...
script menu_data_settings_choosedevice_unfocus 
	retail_menu_unfocus
	if ScreenElementExists \{id = ds_choosedevice}
		ds_choosedevice :setprops \{shadow shadow_rgba = [175 175 150 255] shadow_offs = (2.0, 2.0)}
	endif
endscript
...
script menu_data_settings_overwrite_unfocus 
	retail_menu_unfocus
	if ScreenElementExists \{id = ds_overwrite}
		ds_overwrite :setprops \{shadow shadow_rgba = [175 175 150 255] shadow_offs = (2.0, 2.0)}
	endif
endscript
...
script menu_data_settings_cancel_unfocus 
	retail_menu_unfocus
	if ScreenElementExists \{id = ds_cancel}
		ds_cancel :setprops \{shadow shadow_rgba = [175 175 150 255] shadow_offs = (2.0, 2.0)}
	endif
endscript
...
script menu_data_settings_savegame_unfocus 
	...
	if ScreenElementExists \{id = ds_savegame}
		ds_savegame :setprops \{shadow shadow_rgba = [175 175 150 255] shadow_offs = (2.0, 2.0)}
	endif
endscript
...
script menu_data_settings_loadgame_unfocus 
	...
	if ScreenElementExists \{id = ds_loadgame}
		ds_loadgame :setprops \{shadow shadow_rgba = [175 175 150 255] shadow_offs = (2.0, 2.0)}
	endif
endscript
...
script menu_data_settings_autosave_unfocus 
	...
	if ScreenElementExists \{id = ds_autosave}
		ds_autosave :setprops \{shadow shadow_rgba = [175 175 150 255] shadow_offs = (2.0, 2.0)}
	endif
endscript
