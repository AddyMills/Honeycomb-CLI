...
script create_menu_backdrop \{texture = Venue_BG rgba = [255 255 255 255] z_priority = 0}
...
script TruncateText \{text = "default text" max_chars = 8}
...
script match_rgba \{rgba1 = [0 0 0 255] rgba2 = [255 255 255 255]}
	GetArraySize (<rgba1>)
	<size1> = <array_size>
	GetArraySize (<rgba2>)
	...
	begin
	if (((<rgba1>) [<i>]) != ((<rgba2>) [<i>]))
		return \{rgba_match = 0 FALSE}
	endif
	<i> = (<i> + 1)
	repeat <size1>
	return \{rgba_match = 1 TRUE}
endscript
