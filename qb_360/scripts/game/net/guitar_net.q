...
script create_link_unplugged_dialog 
	destroy_popup_warning_menu
	create_popup_warning_menu \{Title = "CONNECTION LOST" title_props = {Scale = 1.0} textblock = {text = "Your network connection has been disconnected. Returning to the main menu." Pos = (640.0, 380.0)} menu_pos = (600.0, 475.0) options = [{func = connection_lost_resume_play text = "CONTINUE" Scale = (1.0, 1.0)}]}
endscript
