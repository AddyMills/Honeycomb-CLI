...
script create_online_options_changed_dialog \{menu_id = online_options_changed_menu vmenu_id = online_options_changed_vmenu Pos = (500.0, 516.0) z = 100}
	...
	displaySprite \{parent = warning_message_container tex = Dialog_Title_BG Scale = (1.7, 1.7) z = 18 Pos = (640.0, 100.0) just = [RIGHT top] flip_v}
	displaySprite \{parent = warning_message_container tex = Dialog_Title_BG Scale = (1.7, 1.7) z = 18 Pos = (640.0, 100.0) just = [left top]}
	...
	displaySprite \{parent = warning_message_container tex = dialog_bg Pos = (480.0, 500.0) Scale = (1.25, 1.0) z = 18 just = [left botom]}
	displaySprite \{parent = warning_message_container tex = dialog_bg Pos = (480.0, 530.0) Scale = (1.25, 1.0) z = 18 just = [left top] flip_h}
