...
script create_online_main_menu \{menu_title_xenon = "Xbox LIVE Main Menu" menu_title_ps3 = "Online Main Menu" menu_id = online_main_menu vmenu_id = online_main_vmenu}
	online_menu_init
