...
script create_online_server_list 
	...
	CreateScreenElement \{type = vmenu parent = search_results_menu id = search_results_vmenu Pos = (0.0, 0.0) just = [left top] internal_just = [left top] dims = (625.0, 300.0) event_handlers = [{pad_back generic_menu_pad_back params = {callback = menu_flow_go_back}}{pad_up generic_menu_up_or_down_sound params = {up}}{pad_down generic_menu_up_or_down_sound params = {down}}{pad_square refresh_server_list}]}
...
script create_server_list_create_match_dialog \{menu_id = server_list_create_match_dialog_menu vmenu_id = server_list_create_match_dialog_vmenu pad_back_script = create_match_dialog_select_cancel}
	CreateScreenElement {
		type = vscrollingmenu
		parent = search_results_container
		id = <menu_id>
