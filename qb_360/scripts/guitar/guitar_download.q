...
script create_download_scan_menu 
	...
	switch <platform>
		case ps3
		create_popup_warning_menu \{textblock = {text = "Checking the HDD. Do not switch off your console."}}
		wait \{1 gameframes}
		case xenon
		create_popup_warning_menu \{textblock = {text = "Checking for downloadable content. Please don't turn off your Xbox 360 console."}}
	endswitch
