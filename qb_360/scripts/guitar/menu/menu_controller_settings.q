...
script create_controller_settings_menu \{popup = 0}
	...
	if (<popup>)
		...
		displaySprite \{parent = cs_container tex = Options_Controller_CheckBG Pos = (945.0, 205.0) z = 4 flip_h rot_angle = -5 Scale = 0.7}
		displaySprite \{parent = cs_container id = cs_check_1 tex = Options_Controller_X Pos = (975.0, 212.0) z = 6 Scale = 0.7}
		displaySprite \{parent = cs_container tex = Options_Controller_CheckBG Pos = (950.0, 251.0) z = 5 rot_angle = -5 Scale = 0.7}
		displaySprite \{parent = cs_container id = cs_check_2 tex = Options_Controller_X Pos = (970.0, 245.0) z = 6 Scale = 0.7}
		displaySprite {
			parent = cs_container
			id = cs_highlighter
