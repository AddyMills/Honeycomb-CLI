...
script create_choose_practice_section_menu 
	...
	<entry> = (<entry> + 1)
	repeat (<array_size> + 1)
	CreateScreenElement \{type = SpriteElement parent = root_window id = cps_menu Pos = (0.0, 0.0) dims = (1280.0, 720.0) rgba = [100 100 100 255] just = [left top] z_priority = -1 event_handlers = [{pad_up menu_choose_practice_section_input_up}{pad_down menu_choose_practice_section_input_down}{pad_choose menu_choose_practice_section_input_choose}{pad_back menu_choose_practice_section_input_back}]}
	LaunchEvent \{type = focus target = cps_menu}
