...
script create_select_practice_mode_menu 
	...
	CreateScreenElement \{type = TextElement parent = spm_container id = tutorials_text text = "tutorials" font = text_a6 Pos = (555.0, 320.0) Scale = 0.7 rot_angle = -5 just = [center center] event_handlers = [{pad_up switch_training_mode}{pad_down switch_training_mode}{pad_choose choose_training_mode}{pad_back ui_flow_manager_respond_to_action params = {action = go_back}}] z_priority = 10}
