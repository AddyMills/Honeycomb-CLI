...
script training_2_2_show_whammy 
	...
	training_show_lesson_header
	safe_show \{id = lou_icon}
	CreateScreenElement \{parent = training_container type = SpriteElement id = guitar_sprite just = [center center] texture = training_guitar_angle Pos = (300.0, 350.0) rot_angle = 0 rgba = [255 255 255 255] Scale = (0.6, 0.6) z_priority = 20}
...
script training_2_3_explain 
	...
	CreateScreenElement \{parent = training_container type = SpriteElement id = guitar_sprite just = [center center] texture = training_guitar_small Pos = (630.0, 400.0) rot_angle = 45 rgba = [255 255 255 255] Scale = (0.8, 0.8) z_priority = 4}
	wait \{0.5 seconds ignoreslomo}
