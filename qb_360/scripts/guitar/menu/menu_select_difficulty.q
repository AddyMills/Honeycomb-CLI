...
script create_mp_select_difficulty_menu 
	...
	if ($game_mode = p2_career)
		...
		displayText \{parent = sd_container Pos = (640.0, 622.0) just = [center center] text = "Don't wimp out! Lowest difficulty determines cash and unlocks!" rgba = [225 120 60 255] Scale = (0.5, 0.6) z = 11 font = text_a6 noshadow}
		GetScreenElementDims id = <id>
		if (<width> > 400)
