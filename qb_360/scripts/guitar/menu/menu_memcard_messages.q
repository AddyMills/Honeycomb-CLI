...
script create_signin_warning_menu 
	...
	switch <platform>
		case ps3
		create_popup_warning_menu \{textblock = {text = "You are not signed in to the PLAYSTATION®Network. You will be unable to write statistics."} menu_pos = (640.0, 480.0) dialog_dims = (288.0, 64.0) options = [{func = signin_warning_select_continue text = "CONTINUE" Scale = (1.0, 1.0)}]}
		case xenon
		create_popup_warning_menu \{textblock = {text = "You are not signed in to a Xbox 360 gamer profile. You will be unable to save any game content until you sign in." dims = (800.0, 400.0) Scale = 0.5} TextElement = {text = "Do you want to sign in?" Pos = (640.0, 465.0) Scale = 0.6} menu_pos = (640.0, 480.0) dialog_dims = (600.0, 80.0) options = [{func = signin_warning_select_signin text = "SIGN IN"}{func = signin_warning_select_cws text = "CONTINUE WITHOUT SAVING"}]}
	endswitch
endscript
...
script create_no_save_found_menu 
	...
	switch <platform>
		case ps3
		create_popup_warning_menu \{textblock = {text = "No GUITAR HERO III save data found on HDD."} menu_pos = (640.0, 480.0) dialog_dims = (288.0, 64.0) options = [{func = memcard_sequence_quit text = "CONTINUE" Scale = (1.0, 1.0)}]}
		case xenon
		create_popup_warning_menu \{Title = "NO SAVES" textblock = {text = "No GUITAR HERO III saves present."} menu_pos = (640.0, 465.0) dialog_dims = (500.0, 80.0) dialog_pos = (640.0, 450.0) options = [{func = {memcard_sequence_retry params = {StorageSelectorForce = 1}} text = "TRY ANOTHER DEVICE"}{func = memcard_sequence_quit text = "CANCEL"}]}
	endswitch
endscript
...
script create_load_file_menu 
	...
	switch <platform>
		case ps3
		create_popup_warning_menu \{Title = "LOADING..." textblock = {text = "Loading Data. Please do not reset/switch off your console."}}
		case xenon
...
script create_save_menu 
	...
	switch <platform>
		case ps3
		create_popup_warning_menu \{Title = "SAVING..." textblock = {text = "Saving to the HDD. Please do not reset/switch off your console."}}
		case xenon
		create_popup_warning_menu \{Title = "SAVING..." textblock = {text = "Saving Content.\\nPlease don't turn off your console."}}
	endswitch
endscript
