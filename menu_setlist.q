...
script create_sl_assets 
	...
	if GotParam \{tab_downloads}
		displayText \{parent = setlist_menu id = sl_text_1 text = "SECRET SONGS" font = text_a10 Scale = 2 Pos = (330.0, 220.0) rgba = [50 30 20 255] z = $setlist_text_z noshadow}
