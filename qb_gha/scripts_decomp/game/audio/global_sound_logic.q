...
script GH_SFX_Intro_WarmUp 
	...
	switch <pak>
		case z_nipmuc
		playsound \{z_nipmuc_intro vol = 150 buss = Crowd_PreSong_Intro}
		case z_maxskc
		playsound \{z_maxskc_intro vol = 150 buss = Crowd_PreSong_Intro}
		case z_Fenway
		playsound \{z_fenway_intro vol = 150 buss = Crowd_PreSong_Intro}
		case z_nine_lives
		playsound \{z_Nine_Lives_intro vol = 150 buss = Crowd_PreSong_Intro}
		case z_jpplay
		playsound \{z_JPPlay_intro vol = 150 buss = Crowd_PreSong_Intro}
		case z_HOF
		playsound \{z_HOF_intro vol = 150 buss = Crowd_PreSong_Intro}
		default
		playsound \{z_nipmuc_intro vol = 150 buss = Crowd_PreSong_Intro}
	endswitch
endscript
...
script GH_SFX_Play_aerosmith_entrance_Audio_From_Zone_Memory 
	...
	switch <pak>
		...
		case z_video
		case z_nine_lives
		playsound \{z_nine_lives_aerosmith_intro vol = 100 buss = Encore_Events}
		playsound \{Medium_Crowd_Swell_03 vol = 100 buss = Encore_Events pan1x = -0.87 pan1y = -0.5 pan2x = 0.87 pan2y = -0.5}
		playsound \{Large_Crowd_Applause vol = 100 buss = Encore_Events pan1x = -0.87 pan1y = -0.5 pan2x = 0.87 pan2y = -0.5}
		case z_HOF
		playsound \{z_HOF_aerosmith_intro vol = 100 buss = Encore_Events}
		playsound \{Medium_Crowd_Swell_03 vol = 100 buss = Encore_Events pan1x = -0.87 pan1y = -0.5 pan2x = 0.87 pan2y = -0.5}
		playsound \{Large_Crowd_Applause vol = 100 buss = Encore_Events pan1x = -0.87 pan1y = -0.5 pan2x = 0.87 pan2y = -0.5}
		case z_nipmuc
		playsound \{z_nipmuc_Aerosmith_intro vol = 80 buss = Encore_Events}
		SoundEvent \{event = z_Nipmuc_Aerosmith_into_Back_Speakers}
		case z_prison
		case Z_Wikker
		case z_budokan
		case z_Fenway
		playsound \{z_Fenway_Aerosmith_intro vol = 120 buss = Encore_Events}
		SoundEvent \{event = z_Fenway_Aerosmith_into_Back_Speakers}
		case z_jpplay
		playsound \{z_JPPlay_Aerosmith_intro vol = 90 buss = Encore_Events}
		SoundEvent \{event = z_JPPlay_Aerosmith_into_Back_Speakers}
		case z_maxskc
		playsound \{z_maxskc_aerosmith_intro vol = 110 buss = Encore_Events}
		playsound \{Small_Crowd_Swell vol = 70 buss = Encore_Events pan1x = -0.87 pan1y = -0.5 pan2x = 0.87 pan2y = -0.5}
...
script GH_SFX_Play_DMCIntro_Audio_From_Zone_Memory 
	...
	switch <pak>
		...
		case z_video
		case z_nine_lives
		playsound \{z_Nine_Lives_DMC_Intro vol = 135 buss = Encore_Events}
		playsound \{Medium_Crowd_Swell_03 vol = 80 buss = Encore_Events pan1x = -0.87 pan1y = -0.5 pan2x = 0.87 pan2y = -0.5}
		playsound \{Large_Crowd_Applause vol = 80 buss = Encore_Events pan1x = -0.87 pan1y = -0.5 pan2x = 0.87 pan2y = -0.5}
...
script GH_SFX_Play_Encore_Audio_From_Zone_Memory 
	...
	switch <pak>
		case z_party
		playsound \{z_party_encore_L vol = 130 buss = Encore_Events pan1x = -0.5000002 pan1y = 0.8660253}
		playsound \{z_party_encore_R vol = 130 buss = Encore_Events pan1x = 0.5 pan1y = 0.86602545}
		playsound \{z_party_encore_LS vol = 130 buss = Encore_Events pan1x = -0.86602545 pan1y = -0.4999999}
		playsound \{z_party_encore_RS vol = 130 buss = Encore_Events pan1x = 0.86602545 pan1y = -0.5000001}
		case z_dive
		playsound \{z_dive_encore_L vol = 130 buss = Encore_Events pan1x = -0.5000002 pan1y = 0.8660253}
		playsound \{z_dive_encore_R vol = 130 buss = Encore_Events pan1x = 0.5 pan1y = 0.86602545}
		playsound \{z_dive_encore_LS vol = 130 buss = Encore_Events pan1x = -0.86602545 pan1y = -0.4999999}
		playsound \{z_dive_encore_RS vol = 130 buss = Encore_Events pan1x = 0.86602545 pan1y = -0.5000001}
		case z_video
		playsound \{z_video_encore_L vol = 150 buss = Encore_Events pan1x = -0.5000002 pan1y = 0.8660253}
		playsound \{z_video_encore_R vol = 150 buss = Encore_Events pan1x = 0.5 pan1y = 0.86602545}
		playsound \{z_video_encore_LS vol = 150 buss = Encore_Events pan1x = -0.86602545 pan1y = -0.4999999}
		playsound \{z_video_encore_RS vol = 150 buss = Encore_Events pan1x = 0.86602545 pan1y = -0.5000001}
		case z_nine_lives
		playsound \{z_nine_lives_encore_L vol = 250 buss = Encore_Events pan1x = -0.5000002 pan1y = 0.8660253}
		playsound \{z_nine_lives_encore_R vol = 250 buss = Encore_Events pan1x = 0.5 pan1y = 0.86602545}
		playsound \{z_nine_lives_encore_C vol = 250 buss = Encore_Events pan1x = 0.0 pan1y = 1.0}
		playsound \{z_nine_lives_encore_LS vol = 250 buss = Encore_Events pan1x = -0.86602545 pan1y = -0.4999999}
		playsound \{z_nine_lives_encore_RS vol = 250 buss = Encore_Events pan1x = 0.86602545 pan1y = -0.5000001}
		case z_HOF
		playsound \{z_hof_encore_L vol = 100 buss = Encore_Events pan1x = -0.5000002 pan1y = 0.8660253}
		playsound \{z_hof_encore_R vol = 100 buss = Encore_Events pan1x = 0.5 pan1y = 0.86602545}
		playsound \{z_hof_encore_C vol = 100 buss = Encore_Events pan1x = 0.0 pan1y = 1.0}
		playsound \{z_hof_encore_LS vol = 100 buss = Encore_Events pan1x = -0.86602545 pan1y = -0.4999999}
		playsound \{z_hof_encore_RS vol = 100 buss = Encore_Events pan1x = 0.86602545 pan1y = -0.5000001}
		case z_nipmuc
		playsound \{z_nipmuc_encore_L vol = 250 buss = Encore_Events pan1x = -0.5000002 pan1y = 0.8660253}
		playsound \{z_nipmuc_encore_R vol = 250 buss = Encore_Events pan1x = 0.5 pan1y = 0.86602545}
		playsound \{z_nipmuc_encore_C vol = 250 buss = Encore_Events pan1x = 0.0 pan1y = 1.0}
		playsound \{z_nipmuc_encore_LS vol = 250 buss = Encore_Events pan1x = -0.86602545 pan1y = -0.4999999}
		playsound \{z_nipmuc_encore_RS vol = 250 buss = Encore_Events pan1x = 0.86602545 pan1y = -0.5000001}
		case z_prison
		playsound \{z_prison_encore_L vol = 150 buss = Encore_Events pan1x = -0.5000002 pan1y = 0.8660253}
		playsound \{z_prison_encore_R vol = 150 buss = Encore_Events pan1x = 0.5 pan1y = 0.86602545}
		playsound \{z_prison_encore_LS vol = 150 buss = Encore_Events pan1x = -0.86602545 pan1y = -0.4999999}
		playsound \{z_prison_encore_RS vol = 150 buss = Encore_Events pan1x = 0.86602545 pan1y = -0.5000001}
		case Z_Wikker
		playsound \{z_wikker_encore_L vol = 140 buss = Encore_Events pan1x = -0.5000002 pan1y = 0.8660253}
		playsound \{z_wikker_encore_R vol = 140 buss = Encore_Events pan1x = 0.5 pan1y = 0.86602545}
		playsound \{z_wikker_encore_LS vol = 140 buss = Encore_Events pan1x = -0.86602545 pan1y = -0.4999999}
		playsound \{z_wikker_encore_RS vol = 140 buss = Encore_Events pan1x = 0.86602545 pan1y = -0.5000001}
		case z_budokan
		playsound \{z_budokan_encore_L vol = 130 buss = Encore_Events pan1x = -0.5000002 pan1y = 0.8660253}
		playsound \{z_budokan_encore_R vol = 130 buss = Encore_Events pan1x = 0.5 pan1y = 0.86602545}
		playsound \{z_budokan_encore_LS vol = 130 buss = Encore_Events pan1x = -0.86602545 pan1y = -0.4999999}
		playsound \{z_budokan_encore_RS vol = 130 buss = Encore_Events pan1x = 0.86602545 pan1y = -0.5000001}
		case z_Fenway
		playsound \{z_fenway_encore_L vol = 70 buss = Encore_Events pan1x = -0.5000002 pan1y = 0.8660253}
		playsound \{z_fenway_encore_R vol = 70 buss = Encore_Events pan1x = 0.5 pan1y = 0.86602545}
		playsound \{z_fenway_encore_LS vol = 70 buss = Encore_Events pan1x = -0.86602545 pan1y = -0.4999999}
		playsound \{z_fenway_encore_RS vol = 70 buss = Encore_Events pan1x = 0.86602545 pan1y = -0.5000001}
		case z_jpplay
		playsound \{z_jpplay_encore_C vol = 70 buss = Encore_Events pan1x = 0.0 pan1y = 1}
		playsound \{z_jpplay_encore_L vol = 70 buss = Encore_Events pan1x = -0.5000002 pan1y = 0.8660253}
		playsound \{z_jpplay_encore_R vol = 70 buss = Encore_Events pan1x = 0.5 pan1y = 0.86602545}
		playsound \{z_jpplay_encore_LS vol = 70 buss = Encore_Events pan1x = -0.86602545 pan1y = -0.4999999}
		playsound \{z_jpplay_encore_RS vol = 70 buss = Encore_Events pan1x = 0.86602545 pan1y = -0.5000001}
		case z_maxskc
		playsound \{z_MaxsKC_encore_C vol = 250 buss = Encore_Events pan1x = 0.0 pan1y = 1}
		playsound \{z_MaxsKC_encore_L vol = 250 buss = Encore_Events pan1x = -0.5000002 pan1y = 0.8660253}
		playsound \{z_MaxsKC_encore_R vol = 250 buss = Encore_Events pan1x = 0.5 pan1y = 0.86602545}
		playsound \{z_MaxsKC_encore_Ls vol = 250 buss = Encore_Events pan1x = -0.86602545 pan1y = -0.4999999}
		playsound \{z_MaxsKC_encore_Rs vol = 250 buss = Encore_Events pan1x = 0.86602545 pan1y = -0.5000001}
		default
		printf \{"do nothing - default case"}
	endswitch
endscript
...
script GH_SFX_Preload_Boss_Intro_Audio 
	...
	switch <pak>
		...
		if ($current_song = bossjoe)
			printf \{channel = sfx "Preload z_hof intro boss sounds"}
			change \{Joe_Intro_Front_Speakers_unique_id = null}
			change \{Joe_Intro_Back_Speakers_unique_id = null}
			if PreLoadStream \{Joe_Intro_Front_Speakers buss = master}
				change Joe_Intro_Front_Speakers_unique_id = <unique_id>
				waitforpreload_stream \{stream = Joe_Intro_Front_Speakers_unique_id}
			else
				printf \{channel = sfx "Failed preload Joe_Intro_Front_Speakers"}
			endif
			if PreLoadStream \{Joe_Intro_Back_Speakers buss = master}
				change Joe_Intro_Back_Speakers_unique_id = <unique_id>
				waitforpreload_stream \{stream = Joe_Intro_Back_Speakers_unique_id}
			else
				printf \{channel = sfx "Failed preload Joe_Intro_Back_Speakers"}
			endif
			StartPreLoadedStream \{startpaused = 1 $Joe_Intro_Front_Speakers_unique_id vol = 75 pan1x = -0.5 pan1y = 0.86 pan2x = 0.5 pan2y = 0.86 buss = Encore_Events}
			StartPreLoadedStream \{startpaused = 1 $Joe_Intro_Back_Speakers_unique_id vol = 75 pan1x = -0.86 pan1y = -0.49 pan2x = 0.86 pan2y = -0.5 buss = Encore_Events}
		endif
		case z_dive
...
script Star_Power_Deployed_SFX_Multiplayer \{the_player = 1}
	if NOT issoundplaying \{sp_deployed}
		...
		if ($Star_Power_Deployed_Flag = 1)
			setsoundparams \{sp_deployed pan1x = -0.5 pan1y = 0.87 pan2x = 0.5 pan2y = 0.87}
		else
			if (<the_player> = 1)
				SoundEvent \{event = Star_Power_Deployed_SFX_P1}
			else
...
script Star_Power_Ready_SFX_Multiplayer \{which_player = 1}
	if NOT issoundplaying \{sp_available1}
		...
		if ($Star_Power_Ready_Flag = 1)
			setsoundparams \{sp_available1 pan1x = -0.5 pan1y = 0.87 pan2x = 0.5 pan2y = 0.87}
		else
			if (<which_player> = 1)
				SoundEvent \{event = Star_Power_Ready_SFX_P1}
			else
...
script Star_Power_Awarded_SFX_Multiplayer \{player = 1}
	if NOT issoundplaying \{sp_awarded1}
		...
		if ($Star_Power_Awarded_Flag = 1)
			stars
			stars
			setsoundparams \{sp_awarded1 pan1x = -0.5 pan1y = 0.87 pan2x = 0.5 pan2y = 0.87}
		else
			if (<player> = 1)
				SoundEvent \{event = Star_Power_Awarded_SFX_P1}
			else
...
script z_Fenway_Aerosmith_into_Back_Speakers 
	x = 0
	playsound \{Heavy_Crowd_Loop_Good_01 buss = Encore_Events vol = 0 num_loops = -1 pan1x = -0.86602545 pan1y = -0.4999999 pan2x = 0.86602545 pan2y = -0.5000001}
	begin
...
script z_Nipmuc_Aerosmith_into_Back_Speakers 
	x = 0
	playsound \{Nipmuc_Crowd_Loop_Good buss = Encore_Events vol = 0 num_loops = -1 pan1x = -0.86602545 pan1y = -0.4999999 pan2x = 0.86602545 pan2y = -0.5000001}
	begin
...
script z_JPPlay_Aerosmith_into_Back_Speakers 
	x = 0
	playsound \{Heavy_Crowd_Loop_Good_02 buss = Encore_Events vol = 0 num_loops = -1 pan1x = -0.86602545 pan1y = -0.4999999 pan2x = 0.86602545 pan2y = -0.5000001}
	begin
...
script z_maxskc_Aerosmith_into_Back_Speakers 
	x = 80
	playsound \{Medium_Crowd_Loop_Good_01 buss = Encore_Events vol = 80 num_loops = -1 pan1x = -0.86602545 pan1y = -0.4999999 pan2x = 0.86602545 pan2y = -0.5000001}
	wait \{8 seconds}
	begin
...
script DMC_Intro_Rear_Speakers 
	wait \{9.57 seconds}
	playsound \{Medium_Crowd_Swell_03 buss = Encore_Events vol = 100 pan1x = -0.87 pan1y = -0.5 pan2x = 0.87 pan2y = -0.5}
endscript

script You_Rock_Explosion 
	playsound \{You_Rock_Explosion vol = 100}
endscript
