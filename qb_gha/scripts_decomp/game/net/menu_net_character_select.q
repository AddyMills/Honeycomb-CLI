...
script create_leaving_lobby_dialog \{vmenu_id = leaving_lobby_dialog_vmenu pad_back_script = return_to_character_select_from_net_warning pad_choose_script = net_warning_guit_net_game Pos = (640.0, 520.0) z = 110}
