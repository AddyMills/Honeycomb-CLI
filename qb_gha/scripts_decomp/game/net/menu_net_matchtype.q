...
script set_online_menu_highlight_pos \{menu_items = 2}
	switch <menu_items>
		case 2
		SetArrayElement \{arrayName = online_general_menu_hi_lite_ypos globalarray index = 0 newValue = 339.875}
		SetArrayElement \{arrayName = online_general_menu_hi_lite_ypos globalarray index = 1 newValue = 386.75}
		case 3
		SetArrayElement \{arrayName = online_general_menu_hi_lite_ypos globalarray index = 0 newValue = 316.75}
		SetArrayElement \{arrayName = online_general_menu_hi_lite_ypos globalarray index = 1 newValue = 363.625}
		SetArrayElement \{arrayName = online_general_menu_hi_lite_ypos globalarray index = 2 newValue = 410.5}
		case 4
		SetArrayElement \{arrayName = online_general_menu_hi_lite_ypos globalarray index = 0 newValue = 333.0}
		SetArrayElement \{arrayName = online_general_menu_hi_lite_ypos globalarray index = 1 newValue = 380.875}
		SetArrayElement \{arrayName = online_general_menu_hi_lite_ypos globalarray index = 2 newValue = 427.75}
		SetArrayElement \{arrayName = online_general_menu_hi_lite_ypos globalarray index = 3 newValue = 474.625}
	endswitch
endscript
