...
script create_setlist_popup 
	get_number_of_songs
	ui_print_gamertags \{pos1 = (255.0, 130.0) pos2 = (1015.0, 130.0) dims = (400.0, 45.0) just1 = [left top] just2 = [RIGHT top]}
	if (ScreenElementExists id = net_setlist_popup_container)
		return
	endif
	if ((<num_songs> = 1) && (ishost))
		create_ready_icons \{pos1 = (290.0, 340.0) pos2 = (850.0, 220.0)}
		elseif (<num_songs> = 1)
		if NOT (ishost)
			create_ready_icons \{pos1 = (290.0, 240.0) pos2 = (850.0, 320.0)}
		endif
	else
		create_ready_icons \{pos1 = (290.0, 340.0) pos2 = (850.0, 320.0)}
	endif
