...
script create_leaderboard_loading_bar 
	...
	RunScriptOnScreenElement \{id = leaderboard_loading_text_id leaderboard_loading_bar_animate}
...
script new_leaderboard_menu 
	...
	CreateScreenElement \{type = ContainerElement parent = root_window id = leaderboard_container just = [left top] Pos = (-10.0, 0.0)}
	anchor_id = <id>
