...
script igc_camera_update_frame_count 
	if NOT ScreenElementExists \{id = igc_camera_frame_info}
		...
		CreateScreenElement \{type = TextElement parent = igc_camera_frame_info local_id = counter1 Pos = (25.0, 400.0) text = "" font = text_a1 rgba = [60 60 100 200] just = [left center] Scale = 0.8}
		CreateScreenElement \{type = TextElement parent = igc_camera_frame_info local_id = counter2 Pos = (25.0, 418.0) text = "" font = text_a1 rgba = [60 60 100 200] just = [left center] Scale = 0.8}
		CreateScreenElement \{type = TextElement parent = igc_camera_frame_info local_id = counter3 Pos = (25.0, 436.0) text = "" font = text_a1 rgba = [60 60 100 200] just = [left center] Scale = 0.8}
	endif
	FormatText {
		textname = text1
		"Frame %f"
