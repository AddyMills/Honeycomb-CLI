...
script create_debug_backdrop 
	...
	CreateScreenElement \{type = SpriteElement parent = root_window id = debug_backdrop Pos = (640.0, 0.0) dims = (640.0, 720.0) just = [left top] rgba = [0 0 0 255] z_priority = 1}
endscript
...
script create_debugging_menu 
	...
	CreateScreenElement \{type = TextElement parent = debug_vmenu font = text_a1 Scale = 0.75 rgba = [210 210 210 250] text = "Difficulty Analyzer" just = [left top] z_priority = 100.0 shadow shadow_offs = (3.0, 3.0) shadow_rgba = [0 0 0 255] event_handlers = [{focus menu_focus}{unfocus menu_unfocus}{pad_choose debug_difficulty_analyzer}]}
	CreateScreenElement \{type = TextElement parent = debug_vmenu font = text_a1 Scale = 0.75 rgba = [210 210 210 250] text = "Toggle Changelist Number" just = [left top] z_priority = 100.0 shadow shadow_offs = (3.0, 3.0) shadow_rgba = [0 0 0 255] event_handlers = [{focus menu_focus}{unfocus menu_unfocus}{pad_choose debug_toggle_changelist}]}
	CreateScreenElement \{type = TextElement parent = debug_vmenu font = text_a1 Scale = 0.75 rgba = [210 210 210 250] text = "UI Physics Test" just = [left top] z_priority = 100.0 shadow shadow_offs = (3.0, 3.0) shadow_rgba = [0 0 0 255] event_handlers = [{focus menu_focus}{unfocus menu_unfocus}{pad_choose create_ui_physics_test params = {debug}}]}
	CreateScreenElement \{type = TextElement parent = debug_vmenu font = text_a1 Scale = 0.75 rgba = [210 210 210 250] text = "Toggle FPS Display" just = [left top] z_priority = 100.0 shadow shadow_offs = (3.0, 3.0) shadow_rgba = [0 0 0 255] event_handlers = [{focus menu_focus}{unfocus menu_unfocus}{pad_choose ToggleFPS}]}
...
script debug_difficulty_analyzer 
	...
	CreateScreenElement \{type = vmenu parent = song_scrolling_menu id = song_vmenu Pos = (0.0, 0.0) just = [left top] event_handlers = [{pad_up generic_menu_up_or_down_sound params = {up}}{pad_down generic_menu_up_or_down_sound params = {down}}{pad_back difficulty_analyzer_back}]}
	array_entry = 0
	get_songlist_size
	begin
...
script create_difficulty_analyzer_difficulty_menu 
	...
	CreateScreenElement \{type = vmenu parent = difficulty_menu id = difficulty_vmenu Pos = (0.0, 0.0) just = [left top] event_handlers = [{pad_up generic_menu_up_or_down_sound params = {up}}{pad_down generic_menu_up_or_down_sound params = {down}}{pad_back generic_menu_pad_back params = {callback = debug_difficulty_analyzer}}]}
	array_entry = 0
...
script create_songversion_menu 
	...
	CreateScreenElement \{type = TextElement parent = songversion_vmenu font = text_a1 Scale = 0.75 rgba = [210 210 210 250] text = "Play GH3_XP1 Song" z_priority = 100.0 just = [left top] event_handlers = [{focus menu_focus}{unfocus menu_unfocus}{pad_choose create_song_menu params = {version = gh3}}]}
...
script create_settings_menu 
	...
	CreateScreenElement \{type = TextElement parent = settings_vmenu id = create_cameracut_menuitem font = text_a1 Scale = 0.75 rgba = [210 210 210 250] text = "Select CameraCut" just = [left top] z_priority = 100.0 event_handlers = [{focus menu_focus}{unfocus menu_unfocus}{pad_choose create_cameracut_group_menu}]}
...
script create_cameracut_group_menu 
	...
	LaunchEvent \{type = focus target = selectcameracut_group_vmenu}
endscript
...
script toggle_showmeasures 
	...
	if ($debug_showmeasures = Off)
		...
		CreateScreenElement \{type = TextElement parent = root_window id = debug_measures_text font = text_a1 text = "M: 0 : B: 00" Scale = 1 Pos = (850.0, 400.0) rgba = [255 187 0 255] just = [left top] shadow shadow_offs = (3.0, 3.0) shadow_rgba = [0 0 0 255] hide}
		if ($playing_song = 1)
...
script show_tilt_loop 
	if NOT ScreenElementExists \{id = show_tilt_test}
		CreateScreenElement \{type = TextElement parent = root_window id = show_tilt_test Pos = (320.0, 240.0) font = text_a1 text = ""}
	endif
	begin
...
script ToggleFPS 
	if ($toggled_fps_on = 1)
		...
		CreateScreenElement \{type = ContainerElement parent = root_window id = fps_anchor Pos = (30.0, 140.0) just = [center center] internal_just = [left center]}
		CreateScreenElement \{type = TextElement parent = fps_anchor id = fps_text Pos = (20.0, -15.0) text = "FPS: " font = text_a1 rgba = [120 120 200 200] just = [left center] Scale = 0.75 z_priority = 100}
		CreateScreenElement \{type = SpriteElement parent = fps_anchor Pos = (16.0, -34.0) texture = white2 rgba = [10 10 10 180] just = [left top] Scale = (2.55, 0.6) z_priority = 99}
