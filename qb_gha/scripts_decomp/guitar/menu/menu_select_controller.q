...
script create_select_controller_menu 
	...
	CreateScreenElement \{type = SpriteElement parent = msc_container id = msc_light_overlay texture = Venue_Overlay Pos = (640.0, 360.0) dims = (1280.0, 720.0) just = [center center] z_priority = 99}
	if English
	...
	CreateScreenElement \{type = ContainerElement parent = msc_container id = arrow1_container Pos = (450.0, 270.0) rot_angle = -20}
	<id> :settags old_pos = (450.0, 270.0)
	CreateScreenElement \{type = SpriteElement parent = arrow1_container id = arrow1 texture = controller_2p_arrow rgba = [180 80 20 255] dims = (64.0, 128.0) Pos = (0.0, 0.0) just = [left top]}
	CreateScreenElement {
		type = SpriteElement
	...
	CreateScreenElement \{type = ContainerElement parent = msc_container id = arrow2_container Pos = (705.0, 445.0) rot_angle = -20}
	<id> :settags old_pos = (680.0, 420.0)
	CreateScreenElement \{type = SpriteElement parent = arrow2_container id = arrow2 texture = controller_2p_arrow rgba = [90 50 165 255] dims = (64.0, 128.0) Pos = (0.0, 0.0) just = [left top] flip_v flip_h}
	CreateScreenElement {
		type = SpriteElement
...
script controller_move_and_jiggle \{Scale = 0.5 alpha = 0.75}
	if GotParam \{Pos}
		DoMorph Pos = <Pos> Scale = <Scale> alpha = <alpha> relative_scale time = 0.25 motion = ease_in
	endif
	DoMorph \{Pos = {(5.0, 0.0) relative} time = 0.1 motion = ease_in}
	DoMorph \{Pos = {(-10.0, 0.0) relative} time = 0.05}
	DoMorph \{Pos = {(5.0, 0.0) relative} time = 0.1 motion = ease_out}
endscript
