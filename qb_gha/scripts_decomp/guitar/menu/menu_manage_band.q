...
script create_manage_band_menu 
	...
	new_menu \{scrollid = mb_scroll vmenuid = mb_vmenu use_backdrop = 0 menu_pos = (732.0, 322.0) rot_angle = -2 spacing = 1}
	...
	CreateScreenElement \{type = SpriteElement parent = mb_helper_container id = ticket_overlay texture = band_name_ticket_bar_overlay rgba = [255 255 255 255] Pos = (734.0, 360.0) dims = (684.0, 680.0) just = [center center] z_priority = 2}
