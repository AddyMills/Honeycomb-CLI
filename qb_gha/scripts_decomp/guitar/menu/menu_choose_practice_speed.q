...
script create_choose_practice_speed_menu 
	...
	displaySprite \{parent = cps_speed_container id = cps_hilite tex = hilite_bar_01 z = 550 rgba = [120 90 140 255] just = [center center] z = 699}
	displaySprite \{parent = cps_speed_container id = cps_hilite_be1 tex = character_hub_hilite_bookend z = 550 dims = (50.0, 55.0) rgba = [120 90 140 255] just = [RIGHT center] z = 699 flip_v}
	displaySprite \{parent = cps_speed_container id = cps_hilite_be2 tex = character_hub_hilite_bookend z = 550 dims = (50.0, 55.0) rgba = [120 90 140 255] just = [left center] z = 699}
	...
	CreateScreenElement \{type = TextElement parent = cps_speed_container text = "Select Speed" font = text_a10 rgba = [200 90 130 255] Scale = 1.5 Pos = (640.0, 240.0) just = [center center] z_priority = 700}
	CreateScreenElement {
		<text_params>
	...
	add_user_control_helper \{text = "BACK" button = red z = 10000}
