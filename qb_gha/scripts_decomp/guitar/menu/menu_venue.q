...
script create_select_venue_menu \{player = 1}
	...
	CreateScreenElement \{type = SpriteElement id = Venue_Overlay parent = root_window texture = Venue_Overlay Pos = (0.0, 0.0) just = [left top] z_priority = 30 dims = (1280.0, 720.0)}
	CreateScreenElement \{type = SpriteElement id = shadowhole parent = root_window texture = overlay_spotlight Pos = (640.0, 360.0) just = [center center] z_priority = 31 dims = (1280.0, 720.0) rgba = [255 153 204 255] alpha = 0.5 Blend = Add}
	RunScriptOnScreenElement id = <id> circulator params = {time = 3 offs = 100 lag = 1 clockwise}
	getrandomvalue \{name = bg_offset integer a = 5760 b = 12240}
