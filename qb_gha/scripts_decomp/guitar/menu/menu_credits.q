...
script create_credits_menu 
	...
	if NOT ($end_credits = 1)
		...
		CreateScreenElement \{type = SpriteElement id = credits_backdrop parent = credits_backdrop_container texture = endcredits_BG rgba = [255 255 255 255] Pos = (640.0, 360.0) dims = (1300.0, 740.0) just = [center center] z_priority = 0 alpha = 1}
