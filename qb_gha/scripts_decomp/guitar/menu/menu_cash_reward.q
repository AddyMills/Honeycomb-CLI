...
script create_cash_reward_menu 
	...
	CreateScreenElement \{type = SpriteElement parent = cash_reward_container texture = Venue_BG Pos = (640.0, 290.0) Scale = (1.8, 1.8) just = [center center] dims = (1280.0, 720.0) z_priority = -100}
	...
	displaySprite \{parent = cash_reward_container tex = Cash_reward_Pill Pos = (390.0, 580.0) rgba = [0 0 0 255] just = [left center]}
