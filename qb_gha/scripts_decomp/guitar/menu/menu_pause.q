	...
	if (<for_options> = 0)
		if (<for_practice> = 1)
			if English
				...
				vmenu_pause :setprops \{Pos = (0.0, 300.0) spacing_between = -60}
			else
...
script create_pause_menu_frame \{tile_sprite = 1 container_id = pause_menu_frame_container z = 0 gradient = 1 parent = root_window Scale = 1.2}
	create_simple_frame {
...
script create_simple_frame \{center_offset = (0.0, 0.0) Scale = 1.2 z = 0 texture = frame_pause_A container_id = pause_menu_frame_container parent = root_window gradient = 1}
