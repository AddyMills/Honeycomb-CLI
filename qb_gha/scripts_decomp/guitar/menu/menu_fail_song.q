...
script create_fail_song_menu 
	...
	add_user_control_helper \{text = "SELECT" button = green z = 10000}
	add_user_control_helper \{text = "UP/DOWN" button = strumbar z = 10000}
	pausegame
	kill_start_key_binding
endscript

script fail_song_menu_fade_out_lose_anim_sounds 
	setsoundparams \{GH3_Guit_Axel_A_Loss1 vol = 0 time = 1.0}
	setsoundparams \{GH3_Guit_Axel_A_Loss2 vol = 0 time = 1.0}
	setsoundparams \{GH3_Drummer_Lose_01 vol = 0 time = 1.0}
	setsoundparams \{GH3_Drummer_Lose_02 vol = 0 time = 1.0}
	setsoundparams \{GH3_Guit_Izzy_A_Loss1 vol = 0 time = 1.0}
	setsoundparams \{GH3_Guit_John_A_Loss1 vol = 0 time = 1.0}
	setsoundparams \{GH3_Guit_John_A_Loss2 vol = 0 time = 1.0}
	setsoundparams \{GH3_Guitarist_Judy_A_loss_armsUp vol = 0 time = 1.0}
	setsoundparams \{GH3_Guitarist_Judy_A_loss_stomp vol = 0 time = 1.0}
	setsoundparams \{GH3_Guit_Lars_A_Win2 vol = 0 time = 1.0}
	setsoundparams \{GH3_Singer_male_NSLose4 vol = 0 time = 1.0}
	setsoundparams \{GH3_Guit_xavi_A_Loss4 vol = 0 time = 1.0}
	setsoundparams \{GH3_Singer_Steven_lose01 vol = 0 time = 1.0}
endscript
