...
script create_select_difficulty_menu 
	...
	displaySprite \{parent = sd_container tex = Toprockers_Tape_1 Pos = (1150.0, 0.0) dims = (180.0, 128.0) z = 50 rot_angle = 90}
	displaySprite \{parent = sd_container tex = Toprockers_Tape_1 Pos = (1155.0, 3.0) dims = (180.0, 128.0) rgba = [0 0 0 100] z = 49 rot_angle = 90}
	displaySprite \{parent = sd_container tex = Toprockers_Tape_2 Pos = (260.0, 550.0) z = 50 rot_angle = 90 dims = (180.0, 128.0)}
	displaySprite \{parent = sd_container tex = Toprockers_Tape_2 Pos = (264.0, 555.0) rgba = [0 0 0 100] z = 49 rot_angle = 90 dims = (180.0, 128.0)}
	if ($game_mode = p1_career)
...
script create_mp_select_difficulty_menu 
	...
	p2_diff_index = 4
	if ($is_network_game = 1)
		ui_print_gamertags \{pos1 = (270.0, 95.0) pos2 = (1010.0, 95.0) just1 = [left top] just2 = [RIGHT top]}
	else
		...
		displayText \{parent = sd_container text = "1" font = text_A11_Large Pos = (320.0, 180.0) Scale = 1 rgba = [171 189 177 255] noshadow}
		displayText \{parent = sd_container text = "2" font = text_A11_Large Pos = (930.0, 180.0) Scale = 1 rgba = [171 189 177 255] noshadow}
	endif
	CreateScreenElement {
		type = SpriteElement
		id = sd_white_p1
	...
	if ($game_mode = p2_quickplay)
		...
		displayText \{parent = sd_container id = sd_combined_diff_text Pos = (640.0, 500.0) just = [center center] font = text_a6 rgba = [200 160 70 255] Scale = 1.25 noshadow z = 15}
	endif
	if ($is_network_game = 1)
	...
	displaySprite \{parent = sd_container tex = Instrument_2p_Overlay Pos = (0.0, 0.0) dims = (1280.0, 720.0) z = 50 rgba = [105 56 7 160]}
	if ($is_network_game = 1)
		create_ready_icons \{pos1 = (260.0, 200.0) pos2 = (880.0, 190.0)}
	else
...
script sd_create_score_balancing_notice 
	...
	CreateScreenElement \{type = ContainerElement parent = sd_container id = score_balancing_container Pos = (0.0, 0.0)}
	<z> = 20
	<Pos> = (640.0, 556.0)
	CreateScreenElement {
		type = SpriteElement
