...
script unlock_guitar_hover 
	...
	begin
	unlock_item :DoMorph \{Pos = {(0.0, -10.0) relative} rot_angle = -12 motion = ease_out time = 1}
	unlock_item :DoMorph \{Pos = {(0.0, 10.0) relative} rot_angle = -10 motion = ease_in time = 1}
	unlock_item :DoMorph \{Pos = {(0.0, -15.0) relative} rot_angle = -12 motion = ease_out time = 1}
	unlock_item :DoMorph \{Pos = {(0.0, 15.0) relative} rot_angle = -8 motion = ease_in time = 1}
	repeat
endscript
