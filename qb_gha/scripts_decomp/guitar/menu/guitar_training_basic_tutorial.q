...
script training_create_narrator_icons 
	CreateScreenElement \{parent = training_container type = SpriteElement id = god_icon just = [center center] texture = training_narrator_god Pos = (280.0, 140.0) rot_angle = 0 rgba = [255 255 255 255] Scale = (1.4, 1.4) z_priority = 5}
	CreateScreenElement \{parent = training_container type = SpriteElement id = lou_icon just = [center center] texture = training_narrator_lou Pos = (280.0, 140.0) rot_angle = 0 rgba = [255 255 255 255] Scale = (1.4, 1.4) z_priority = 5}
...
script create_pressed_note_sprites 
	CreateScreenElement \{parent = training_container type = SpriteElement id = green_pressed_sprite just = [center center] texture = training_guitar_button_down Pos = (441.0, 396.0) rot_angle = 0 rgba = [0 165 130 255] Scale = (0.36, 0.36) z_priority = 5}
	CreateScreenElement \{parent = training_container type = SpriteElement id = red_pressed_sprite just = [center center] texture = training_guitar_button_down Pos = (508.0, 396.0) rot_angle = 0 rgba = [230 80 90 255] Scale = (0.36, 0.36) z_priority = 5}
	CreateScreenElement \{parent = training_container type = SpriteElement id = yellow_pressed_sprite just = [center center] texture = training_guitar_button_down Pos = (575.0, 396.0) rot_angle = 0 rgba = [220 160 25 255] Scale = (0.36, 0.36) z_priority = 5}
	CreateScreenElement \{parent = training_container type = SpriteElement id = blue_pressed_sprite just = [center center] texture = training_guitar_button_down Pos = (642.0, 396.0) rot_angle = 0 rgba = [0 135 210 255] Scale = (0.36, 0.36) z_priority = 5}
	CreateScreenElement \{parent = training_container type = SpriteElement id = orange_pressed_sprite just = [center center] texture = training_guitar_button_down Pos = (709.0, 396.0) rot_angle = 0 rgba = [215 120 40 255] Scale = (0.36, 0.36) z_priority = 5}
	hide_pressed_notes
endscript
