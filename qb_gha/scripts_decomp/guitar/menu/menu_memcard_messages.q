...
script create_autologin_prompt_menu 
	memcard_cleanup_messages
	create_popup_warning_menu \{textblock = {text = "Do you want to automatically login each time you run Guitar Hero: Aerosmith? You can change your selection under the Options Menu later." dims = (800.0, 400.0) Scale = 0.5} menu_pos = (640.0, 480.0) dialog_dims = (340.0, 80.0) options = [{func = set_autologin_yes_result text = "YES"}{func = set_autologin_no_result text = "NO"}]}
endscript
...
script create_signin_warning_menu 
	...
	if NOT IsWinPort
		...
		switch <platform>
			case ps3
			create_popup_warning_menu \{textblock = {text = "You are not signed in to the PLAYSTATION®Network. You will be unable to write statistics."} menu_pos = (640.0, 480.0) dialog_dims = (288.0, 64.0) helper_pills = [select] options = [{func = signin_warning_select_continue text = "CONTINUE" Scale = (1.0, 1.0)}]}
			case xenon
			create_popup_warning_menu \{textblock = {text = "You are not signed in to a Xbox 360 gamer profile. You will be unable to save any game content until you sign in." dims = (800.0, 400.0) Scale = 0.5} TextElement = {text = "Do you want to sign in?" Pos = (640.0, 465.0) Scale = 0.6} menu_pos = (640.0, 480.0) dialog_dims = (600.0, 80.0) helper_pills = [select updown] options = [{func = signin_warning_select_signin text = "SIGN IN"}{func = signin_warning_select_cws text = "CONTINUE WITHOUT SAVING"}]}
		endswitch
	endif
endscript
...
script create_signin_complete_menu 
	memcard_cleanup_messages
	create_popup_warning_menu \{textblock = {text = "This game saves data automatically at certain points. Do not switch off the power when the HDD access indicator is flashing." Pos = (640.0, 380.0) Scale = 0.6} menu_pos = (640.0, 490.0) dialog_dims = (384.0, 64.0) helper_pills = [select] options = [{func = signin_complete_menu_select_ok text = "OK" Scale = (1.0, 1.0)}]}
...
script create_no_save_found_menu 
	...
	if NOT IsWinPort
		...
		switch <platform>
			case ps3
			create_popup_warning_menu \{textblock = {text = "No GUITAR HERO Aerosmith save data found on HDD."} menu_pos = (640.0, 480.0) dialog_dims = (288.0, 64.0) helper_pills = [select] options = [{func = memcard_sequence_quit text = "CONTINUE" Scale = (1.0, 1.0)}]}
			case xenon
			create_popup_warning_menu \{Title = "NO SAVES" textblock = {text = "No GUITAR HERO Aerosmith saves present."} menu_pos = (640.0, 465.0) dialog_dims = (500.0, 80.0) dialog_pos = (640.0, 450.0) helper_pills = [select updown] options = [{func = {memcard_sequence_retry params = {StorageSelectorForce = 1}} text = "TRY ANOTHER DEVICE"}{func = memcard_sequence_quit text = "CANCEL"}]}
		endswitch
	endif
endscript
...
script create_delete_failed_menu 
	...
	switch <platform>
		case ps3
		create_popup_warning_menu \{Title = "DELETE FAILED!" textblock = {text = "Delete Failed!  Please exit the game and delete this game data."} menu_pos = (640.0, 465.0) dialog_dims = (275.0, 64.0) helper_pills = [select updown] options = [{func = memcard_sequence_retry text = "RETRY"}{func = memcard_sequence_quit text = "CONTINUE"}]}
		case xenon
		create_popup_warning_menu \{Title = "DELETE FAILED!" textblock = {text = "Unable to delete."} menu_pos = (640.0, 465.0) dialog_dims = (275.0, 64.0) helper_pills = [select updown] options = [{func = memcard_sequence_retry text = "RETRY"}{func = memcard_sequence_quit text = "CONTINUE"}]}
	endswitch
endscript
...
script create_load_failed_menu 
	...
	switch <platform>
		case ps3
		create_popup_warning_menu \{textblock = {text = "Failed to load. The save appears to be corrupt." Pos = (640.0, 380.0)} menu_pos = (640.0, 465.0) dialog_dims = (275.0, 64.0) helper_pills = [select updown] options = [{func = memcard_sequence_retry text = "RETRY"}{func = memcard_sequence_quit text = "CONTINUE"}]}
		case xenon
		create_popup_warning_menu \{textblock = {text = "Failed trying to load." Pos = (640.0, 380.0)} menu_pos = (640.0, 465.0) dialog_dims = (275.0, 64.0) helper_pills = [select updown] options = [{func = memcard_sequence_retry text = "RETRY"}{func = memcard_sequence_quit text = "CONTINUE"}]}
	endswitch
endscript
...
script create_save_failed_menu 
	...
	switch <platform>
		case ps3
		create_popup_warning_menu \{textblock = {text = "Failed trying to save." Pos = (640.0, 380.0)} menu_pos = (640.0, 465.0) dialog_dims = (275.0, 64.0) helper_pills = [select updown] options = [{func = memcard_sequence_retry text = "RETRY"}{func = memcard_sequence_quit text = "CONTINUE"}]}
		case xenon
		create_popup_warning_menu \{textblock = {text = "Save Failed.\\nNo storage device was selected or the in-use storage device is unavailable." Pos = (640.0, 380.0)} menu_pos = (640.0, 465.0) dialog_dims = (275.0, 64.0) helper_pills = [select updown] options = [{func = memcard_sequence_retry text = "RETRY"}{func = memcard_sequence_quit text = "CONTINUE"}]}
	endswitch
endscript
...
script create_overwrite_failed_menu 
	...
	switch <platform>
		case ps3
		create_popup_warning_menu \{textblock = {text = "Failed trying to overwrite." Pos = (640.0, 380.0)} menu_pos = (640.0, 465.0) dialog_dims = (275.0, 64.0) helper_pills = [select updown] options = [{func = memcard_sequence_retry text = "RETRY"}{func = memcard_sequence_quit text = "CONTINUE"}]}
		case xenon
...
script create_out_of_space_menu 
	...
	switch <platform>
		...
		case xenon
		if ($MemcardSavingOrLoading = saving)
			create_popup_warning_menu \{textblock = {text = ["No space to save" "\\n" "Please delete some existing data."] Pos = (640.0, 390.0) dims = (900.0, 490.0) Scale = 0.5} menu_pos = (640.0, 465.0) dialog_dims = (600.0, 80.0) helper_pills = [select] options = [{func = memcard_disable_saves_and_quit text = "CONTINUE WITHOUT SAVING"}]}
		else
