...
script create_UI_frame \{frame_dims = (300.0, 500.0) check_side_swap = 1 center_pos = (640.0, 360.0) parent = root_window frame_rgba = [255 255 255 255] fill_rgba = [0 0 0 255] z_priority = 100 offset_top = 63 offset_side = 91 min_fill_pad_width = 73 min_fill_pad_height = 129 tex_param = 'aero' suffix = 0 offset_TL = (-0.5, -0.5) offset_TR = (-0.5, -0.5) offset_BL = (-0.5, -0.5) offset_BR = (-0.5, -0.5)}
	if IsWinPort
		GetDisplaySettings
		if ((<width> != 1280) || (<height> != 720))
			SetArrayElement \{arrayName = fill_rgba index = 3 newValue = 230}
			offset_TL = (0.3, 0.3)
			offset_TR = (-0.3, 0.3)
			offset_BL = (0.3, -0.3)
			offset_BR = (-0.3, -0.3)
			if (<tex_param> = 'simple')
				if ((<frame_dims>.(1.0, 0.0)) = 350)
					...
					SetArrayElement \{arrayName = fill_rgba index = 3 newValue = 250}
					offset_TL = (0.1, 0.25)
					offset_TR = (-0.1, 0.25)
					offset_BL = (0.1, -0.25)
					offset_BR = (-0.1, -0.25)
...
script random_ui_frame_morph_test 
	...
	begin
	getrandomvalue \{name = frames a = 60 b = 240 integer}
	getrandomvalue \{name = rand_x_dims a = 256 b = 600 integer}
	getrandomvalue \{name = rand_y_dims a = 256 b = 600 integer}
	getrandomvalue \{name = rand_x_pos a = 340 b = 940 integer}
	getrandomvalue \{name = rand_y_pos a = 180 b = 580 integer}
...
script create_gamertag_frame \{parent = root_window text_width = 100 text_height = 50 rgba = [0 0 0 70] player = 1 Pos = (0.0, 0.0) z = 0}
	vfudge = -2
