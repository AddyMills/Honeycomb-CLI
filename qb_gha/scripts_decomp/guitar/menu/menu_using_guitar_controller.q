...
script create_using_guitar_controller_menu \{keyboard = 0}
	...
	CreateScreenElement \{type = ContainerElement parent = root_window id = ugc_container Pos = (0.0, 0.0) z_priority = 1000}
	...
	CreateScreenElement \{type = TextElement parent = ugc_container id = bg_helper_text font = text_a4 rgba = [223 223 223 255] Scale = 0.5 just = [center top] noshadow z_priority = 1002}
	CreateScreenElement {
		type = SpriteElement
		parent = ugc_container
		texture = <guitar_tex>
...
script menu_using_guitar_controller_add_text_tilt_starpower 
	...
	CreateScreenElement \{type = SpriteElement parent = ugc_container texture = boot_usingGuitar_arrow Pos = (270.0, 460.0) just = [RIGHT center]}
endscript
