...
script create_exploding_text \{parent = 'you_rock_physics' text = "You Rock!" placement = top just = [center bottom]}
...
script destroy_all_exploding_text 
	FormatText \{checksumname = cont_id_1 'you_rock_physics'}
	FormatText \{checksumname = cont_id_2 'you_rock_2_physics'}
	FormatText \{checksumname = cont_id_3 'you_rock_legend_physics'}
...
script create_exploding_particles 
	CreateScreenElement \{type = ContainerElement id = exploding_particle_container parent = root_window Pos = (0.0, 0.0)}
	<i> = 0
	begin
	FormatText checksumname = particle_id 'particle_%i' i = <i>
	getrandomvalue \{a = 280.0 b = 980.0 name = rand_x}
	getrandomvalue \{a = 200.0 b = 400.0 name = rand_y}
...
script do_text_slam \{time = 1.0}
	...
	if (<explode> = 1)
		CreateScreenElement \{type = SpriteElement parent = root_window texture = white rgba = [255 255 255 255] dims = (1280.0, 720.0) Pos = (0.0, 0.0) just = [left top] z_priority = 1000}
...
script do_extra_exploding_particles \{z_priority = 8.0 Pos = (640.0, 200.0) parent = exploding_particle_container}
	...
	wait \{1.5 seconds}
	destroy2dparticlesystem \{id = extra_particles kill_when_empty}
	return
endscript
...
script do_exploding_text_physics 
	...
	getrandomvalue \{a = 3 b = 7 name = rand_time}
...
script do_exploding_text_particle_physics 
	...
	begin
	FormatText checksumname = particle_id 'particle_%i' i = <i>
	getrandomvalue \{a = 0.1 b = 3.0 name = rand_time}
	DoScreenElementMorph id = <particle_id> alpha = 0 time = <rand_time>
	<i> = (<i> + 1)
	repeat ($num_exploding_particles)
endscript

script split_text_into_physics_array_elements \{text = "You Rock!" text_pos = (0.0, 0.0) space_between = (0.0, 0.0) flags = {}}
