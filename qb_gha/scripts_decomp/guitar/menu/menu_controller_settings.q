...
script create_controller_settings_menu \{popup = 0}
	...
	if (<popup>)
		...
		displaySprite \{parent = cs_container tex = tape_H_02 Pos = (950.0, 410.0) dims = (112.0, 54.0) z = 4 rot_angle = -40}
		displaySprite \{parent = cs_container tex = tape_H_02 Pos = (953.0, 413.0) dims = (112.0, 54.0) rgba = [0 0 0 128] z = 3 rot_angle = -40}
		CreateScreenElement {
			type = TextElement
