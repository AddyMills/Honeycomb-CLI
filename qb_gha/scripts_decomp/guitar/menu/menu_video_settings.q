...
script create_video_settings_menu \{popup = 0}
	...
	if (<popup> = 0)
		new_menu \{scrollid = vs_scroll vmenuid = vs_vmenu font = $video_settings_menu_font menu_pos = (300.0, 400.0) spacing = 8 text_left focus_color = light_grey unfocus_color = pink2}
