...
script create_press_any_button_menu 
	...
	CreateScreenElement \{type = SpriteElement parent = pab_container id = pab_menu_backdrop texture = boot_copyright_bg rgba = [255 255 255 255] Pos = (640.0, 360.0) dims = (1280.0, 720.0) just = [center center] z_priority = 0}
...
script create_attract_mode_text 
	...
	CreateScreenElement \{type = SpriteElement parent = am_container texture = main_menu_logo Scale = 0.9 Pos = (640.0, 465.0) just = [center center]}
endscript
	...
	if NOT IsWinPort
		if IsStandardGuitarControllerPluggedIn
			if English
				...
				elseif French
				notify_box \{scale1 = (0.6, 0.75) scale2 = (0.5, 0.6) container_pos = (0.0, 350.0) container_id = notify_invalid_device line1 = "Une guitare non compatible a été détectée." line2 = "Connecter une manette guitare Guitar Hero ou" line3 = "une manette Xbox 360 et appuyer sur la touche START pour continuer." menu_z = 510000}
				elseif Italian
				notify_box \{scale1 = (0.6, 0.75) scale2 = (0.5, 0.6) container_pos = (0.0, 350.0) container_id = notify_invalid_device line1 = "È stata rilevata una periferica chitarra non supportata." line2 = "Collegare una chitarra Guitar Hero o" line3 = "un Controller Xbox 360 e premere START per continuare." menu_z = 510000}
				elseif German
				...
				elseif Spanish
				notify_box \{scale1 = (0.45000002, 0.75) scale2 = (0.5, 0.6) container_pos = (0.0, 350.0) container_id = notify_invalid_device line1 = "Se ha detectado una guitarra conectada como periférico no compatible." line2 = "Conecta una guitarra Guitar Hero o" line3 = "el mando Xbox 360 y pulsa START para continuar." menu_z = 510000}
			endif
