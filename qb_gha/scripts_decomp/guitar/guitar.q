...
script guitar_startup 
	...
	if IsWinPort
		if NotIsMacPort
			DisplayLoadingScreen \{'boot_legal' spin_texture = 'load_wheel' spin_x = 384 spin_y = 490 localized}
		else
			DisplayLoadingScreen \{'boot_legal_mac' spin_texture = 'load_wheel' spin_x = 384 spin_y = 490 localized}
		endif
	else
...
script restore_dummy_bg_camera 
	...
	PlayIGCCam \{name = dummy_cam_bg viewport = bg_viewport Pos = (-2.391084, 1.860994, 9.406317) Quat = (0.001788, 0.993925, -0.016326997) FOV = 72.0 Play_hold}
endscript
