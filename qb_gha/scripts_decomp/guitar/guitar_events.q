...
script Sudden_Death_Helper_Text 
	CreateScreenElement \{type = ContainerElement id = sudden_death_helper_container parent = root_window Pos = (0.0, 0.0)}
...
script Boss_Unlocked_Text 
	disable_pause
	CreateScreenElement \{type = ContainerElement id = boss_unlocked_text_container parent = root_window Pos = (0.0, 0.0)}
	if ($current_song = bossjoe)
